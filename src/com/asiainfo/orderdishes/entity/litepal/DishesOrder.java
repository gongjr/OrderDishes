 ...
 * @author zhouwx
 */
public class DishesOrder extends DataSupport implements Serializable {
    ...
    private String inMode;//订单渠道来源  0是微信， 1是pad端
    ...
    public DinnerDesk getDinnerDesk() {
        return dinnerDesk;
    }

    public void setDinnerDesk(DinnerDesk dinnerDesk) {
    ...
    public void setTradeStaffId(String tradeStsffId) {
        this.tradeStaffId = tradeStsffId;
    }
    ...
    public List<OrderGoods> getItemlistDb() {
        this.orderGoods = (ArrayList<OrderGoods>) DataSupport.where("dishesorder_id = ?", String.valueOf(id)).find(OrderGoods.class);
        return orderGoods;
    }
