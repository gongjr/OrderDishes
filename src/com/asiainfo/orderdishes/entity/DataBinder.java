...
public class DataBinder<T> {
    ...
    public void saveAllDishesType(Collection<DishesType> collection) {
        DataSupport.saveAll(collection);

    }

    public void saveAllDishesInfo(Collection<DishesInfo> collection) {
        DataSupport.saveAll(collection);

    }

    public void saveAllMerchantCompDishesType(Collection<MerchantCompDishesType> collection) {
        DataSupport.saveAll(collection);

    }

    public void saveAllDishesItemType(Collection<DishesItemType> collection) {
        DataSupport.saveAll(collection);

    }

    public void saveAllDishesItem(Collection<DishesItem> collection) {
        DataSupport.saveAll(collection);

    }

    public void saveAllOrderGoods(Collection<OrderGoods> collection) {
        DataSupport.saveAll(collection);
