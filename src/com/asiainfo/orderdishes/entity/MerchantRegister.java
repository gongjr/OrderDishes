...
public class MerchantRegister {
    ...
    public MerchantRegister(String userName, String mD5password, String toId,
                            String userAddress, String phone, String email, String qq, String childMerchantId,
                            String merchantId, String roleCode) {
        this.userName = userName;
        this.passwd = mD5password;
        this.toId = toId;
