...
//            System.exit(0);
    ...
    private boolean handleException(Throwable ex) {
        ...
        collectDeviceInfo(mContext,baseApp.getLoginInfo());
    ...
    private void initToast() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.toast_content_view, null, false);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                String path = "/sdcard/orderdishes_crash_log/";
